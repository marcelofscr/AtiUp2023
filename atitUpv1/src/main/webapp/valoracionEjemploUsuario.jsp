...
<html lang="en">
    <head>
        <title>ValoracionesEjemplo</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="w3-container" id="contact" style="margin-top:75px">
            ...
            <form action="../controladorValoracionEjemplo" method="POST">
                ...
                <div class="w3-section">
                 ...
                 <div class="w3-section">
                    <label for="example">ID Ejemplo </label>
                    <textarea name="example" rows="2" cols="40"></textarea><br><br>                 
